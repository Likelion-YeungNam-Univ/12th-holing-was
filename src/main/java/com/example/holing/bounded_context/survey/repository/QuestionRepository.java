...
@Repository
public interface QuestionRepository extends JpaRepository<SymptomQuestion, Long> {
    /**
     ...
     * @return
     */
    @Query("select q from SymptomQuestion q join fetch q.tag t where t.id != 6")
    List<SymptomQuestion> findAllByTagNotPeriod();
}
